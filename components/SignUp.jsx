          ...
          <div className="w-full max-w-[560px] px-[30px]">
            ...
            <form onSubmit={submitForm} method="post" className="w-full">
              <div className="submit-form">
                ...
                <label className="cursor-pointer relative pl-[20px]">
                  <input
                    type="checkbox"
                    className="peer absolute top-0 left-0 w-0 h-0"
                  />
                  <span className='checkbox absolute top-[1px] left-0 w-[18px] h-[18px] border-[#eee] border-[2px] border-solid after:content-["✔"] after:absolute after:-top-1 after:left-1 after:text-[#777] after:opacity-0 after:scale-0 peer-checked:after:opacity-100 peer-checked:after:scale-100 after:transition-all after:duration-300'></span>{" "}
                  <span className="ml-[8px] text-[13px] text-[#777]">
                    Remember Me
                  </span>
                </label>
                <div className="my-[35px]">
                  <button
                    type="submit"
                    href=""
                    className="px-[25px] py-[15px] bg-yel text-white text-[13px] hover:bg-black transition-all duration-300"
                  >
                    SIGN UP
                  </button>
                </div>
            ...
            <div className="text-[#777] text-[14px]">
              ...
              <button
                className="login text-yel transition-all duration-300 "
                onClick={(e) => {
                  e.preventDefault();
                  switchToLogin();
                }}
