...
const Account = ({closeAccount, logOut}) => {
  return (
    <div className='flex flex-col items-center bg-white p-[20px] rounded-2xl absolute top-[120%] right-0'>
      <button className='absolute top-3 right-3 ' onClick={(e) =>  {
                e.preventDefault();
                closeAccount();
            }}>
        <FaXmark/>
      ...
      <Image 
        ...
        <a className='text-black px-[40px] py-[8px] border-2 border-black rounded-3xl mb-[10px]' href="">Manage your account</a>
        <a className='text-black' href="" onClick={(e)=>{
          e.preventDefault();
          logOut();
          closeAccount();
        }}>Sign out</a>
